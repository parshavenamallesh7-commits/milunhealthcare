...
export default function MilunHealthcare(): ReactElement {
  ...
  const productImages = {
    "mi-sum-vit": [
      { src: "/products/MY%20SUM%20VIT.jpeg", alt: "My Sum Vit Tablets - Front View" },
      { src: "/products/MY%20SUM%20VIT%20(2).jpeg", alt: "My Sum Vit Tablets - Side View" },
    ],
    "mi-red-z-one": [
    ...
    "mi-cal-zm": [
      { src: "/products/MI%20CAL%20ZM.jpeg", alt: "Mi Cal ZM Tablets - Front View" },
      { src: "/products/MI%20CAL%20ZM%20(2).jpeg", alt: "Mi Cal ZM Tablets - Side View" },
      { src: "/products/MI%20CAL%20ZM%20(3).jpeg", alt: "Mi Cal ZM Tablets - With Blister Pack" },
    ],
    "etomil-mr": [
    ...
    "ferti-fa-q10": [
      { src: "/products/MUST%20Q10.jpeg", alt: "MUST Q10 Tablets - Front View" },
      { src: "/products/MUST%20Q10%20(2).jpeg", alt: "MUST Q10 Tablets - Side View" },
    ],
    "doxy-mil-od": [
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            >
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-black text-[#007BFF] mb-4 text-center">
                  MUST Q10™ <span className="text-green-600">Tablets</span>
                </h3>
