...
export default function MilunHealthcare(): ReactElement {
  ...
  const productImages = {
    ...
    "etomil-mr": [
      { src: "/products/eto1.jpeg", alt: "EtoMil MR Tablets - Front View" },
    ],
    "mi-cal-k2": [
  ...
  const handleWhatsApp = () => {
    ...
    window.open(`https://wa.me/919490370472?text=${message}`, "_blank", "noopener,noreferrer")
  }
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-lg border-b border-[#E6F0FA]">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <Image src="/logo.png" alt="Milun Healthcare Logo" width={55} height={55} className="rounded-full" priority />
            <div>
      ...
      <section id="products" className="py-24 bg-gradient-to-br from-[#E6F0FA] to-[#F8FBFF]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 max-w-7xl mx-auto sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-black text-[#2fba04] mb-4 text-center">
                  My Sum Vit™ <span className="text-[#28A745]">Tablets</span>
                </h3>
            ...
            <Card
              className={`bg-white rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 border-2 border-transparent hover:border-[#007BFF]/20 ${isVisible["products"] ? "animate-fade-in" : "opacity-0"}`}
            >
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <div className="bg-gradient-to-r from-[#E6F0FA] to-[#F8FBFF] p-3 rounded-full">
                    <Pill className="text-[#007BFF]" size={32} />
                  </div>
                </div>
                <h3 className="text-xl font-black text-[#007BFF] mb-4 text-center">
                  Boon Fol™ <span className="text-[#28A745]">Tablets</span>
                </h3>
                <div className="relative mb-4">
                  <div className="flex justify-center">
                    <div className="relative group">
                      <Image
                        src={productImages["boon-fol"][currentImageIndex["boon-fol"]].src || "/placeholder.svg"}
                        alt={productImages["boon-fol"][currentImageIndex["boon-fol"]].alt}
                        width={300}
                        height={300}
                        loading="lazy"
                        className="w-full max-w-[300px] h-auto rounded-xl shadow-lg group-hover:shadow-2xl transition-all duration-300"
                ...
                <div className="bg-gradient-to-r from-[#F2F8FF] to-[#E6F0FA] p-4 rounded-xl">
                  <p className="text-gray-700 text-center text-sm leading-relaxed">
                    A trusted <span className="font-bold text-[#007BFF]">folic acid supplement</span> for pregnancy support and daily wellness.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="mt-12 flex justify-center">
            <Link href="/products">
              <Button className="bg-gradient-to-r from-[#28A745] to-[#007BFF] hover:from-[#007BFF] hover:to-[#28A745] text-white px-8 py-4 text-lg rounded-xl font-bold transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
                View More
              </Button>
            </Link>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-blue-200">+91 9490370472</p>
                </div>
                <div className="flex items-center space-x-3">
          ...
          <div className="border-t border-white/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-center md:text-left">
                <p className="text-lg font-semibold">© {new Date().getFullYear()} Milun Healthcare. All Rights Reserved.</p>
